...
export const MOCK_TRUCKS = [
  ...
  },
  {
    ...
    varianceKg: 1500, // Missing coal / Discrepancy
...
export const MOCK_VESSELS = [
  ...
  },
  {
    ...
    predictedCostUSD: 0,
    weatherCondition: 'Light Winds',
    tomTomCongestionIndex: 12,
    discrepancyTons: 0
  },
  {
    id: 'VES-TATA-NAV',
    name: 'MV Tata Navigator',
    imo: 'IMO 9123456',
    flag: 'India',
    capacityTons: 80000,
    expectedTons: 55000,
    loadedTons: 54600, // 400T Discrepancy
    cargoSpec: 'Metallurgical Coking Coal',
    originPort: 'Richards Bay Dry Bulk Terminal (South Africa)',
    destinationPort: 'Mundra Port Bulk Siding (India)',
    incoterm: 'CIF',
    client: 'Tata International Bulk Minerals',
    laycanStart: '2026-09-23',
    laycanEnd: '2026-09-27',
    cancellingDate: '2026-09-27T18:00:00Z',
    noticeOfReadiness: 'Pending',
    laytimeAllowedHours: 60,
    laytimeUsedHours: 0,
    laytimeRemainingHours: 60,
    berthSlot: 'Unassigned',
    berthWindow: 'Pending Weather Clearance',
    marineTrafficStatus: 'DELAYED_AT_ANCHORAGE',
    destinationBerthStatus: 'PORT_CLOSED_WEATHER',
    demurrageRiskStatus: 'LAYCAN_RISK',
    demurrageRatePerDay: 30000,
    predictedDemurrageDays: 1.5,
    predictedCostUSD: 45000,
    weatherCondition: 'Severe Storms / High Swell',
    tomTomCongestionIndex: 95,
    discrepancyTons: 400
  }
]
...
export const DEMO_SCENARIOS = [
  {
    id: 'scen-demo-a',
    title: 'Demo A: CIF Severe Weather Demurrage',
    badge: 'DEMURRAGE RISK',
    badgeColor: 'rose',
    description: 'MV Tata Navigator is delayed at anchorage off Richards Bay due to severe storms and high swell. Port is closed. Likely to incur demurrage of $45,000.',
    incoterm: 'CIF',
    client: 'Tata International Bulk Minerals',
    vesselId: 'VES-TATA-NAV',
    product: 'Metallurgical Coking Coal',
    volume: 55000,
    portOfLoading: 'Richards Bay Dry Bulk Terminal',
    portOfDestination: 'Mundra Port Bulk Siding',
    demurrageAmountUSD: 45000
  },
  {
    id: 'scen-demo-b',
    title: 'Demo B: DAP Laycan Miss Alert',
    badge: 'LAYCAN RISK',
    badgeColor: 'amber',
    description: 'Truck gate congestion (TomTom Index 95) at Witbank mine is slowing down delivery to Richards Bay for MV Jindal Enterprise. Risk of missing cancelling date by 14 hours.',
    incoterm: 'DAP',
    client: 'Jindal Steel & Power Ltd',
    ...
    volume: 68500,
    portOfLoading: 'Richards Bay Dry Bulk Terminal',
    portOfDestination: 'New Mangalore Bulk Port',
    demurrageAmountUSD: 98000
  },
  {
    id: 'scen-demo-c',
    title: 'Demo C: FOB Perfect Flow',
    badge: 'ON SCHEDULE',
    badgeColor: 'emerald',
    description: 'MV African Flame is loading at Maputo berth #04 under FOB. Truck haulage rate is optimal, laytime 30 hours remaining. Making it to the ship perfectly.',
    incoterm: 'FOB',
    client: 'ArcelorMittal Global Trading',
  ...
  },
  {
    ...
    title: 'DAP SA → India: Destination Terminal 0 Slots',
    badge: 'CRITICAL DEMURRAGE RISK',
    badgeColor: 'rose',
    description: 'MV Jindal Enterprise is enroute from Richards Bay (SA) to Mangalore (India) under DAP. Destination terminal has 0 open slots. Predicted demurrage penalty: $98,000.',
    incoterm: 'DAP',
    client: 'Jindal Steel & Power Ltd',
    vesselId: 'VES-JINDAL-ENT',
    product: 'RB1 High CV Export Coal',
